...
# install packages
PACKAGES=("python3.7" "python3-tk" "python3-pip" "libpython3.7-dev" "git" "ffmpeg" "xsel" "wmctrl")
...
Icon=$HOME/$VIRGIL_FOLDER/$DEST_DIR/src/gui/img/5_megaphone.png
Terminal=true
Type=Application
Encoding=UTF-8
...
$( which python3.7 ) $DIR/get_time.py
